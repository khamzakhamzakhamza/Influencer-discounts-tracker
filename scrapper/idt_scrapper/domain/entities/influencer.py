...
class Influencer:
    def __init__(self, channel_id: str, username: str, title: str, channel_url: str, image_url: str, id: str, last_update_date: datetime, creation_date: datetime, version: int = 1):
        self.id = id
